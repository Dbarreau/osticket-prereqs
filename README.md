...
1. Search "Virtual Machine" with a Microsoft Azure account
...
15. Login with the username and password
16. After the VM finishes loading, hit "No" for all the settings
17. __Now The Virtual Machine Installation Complete!__


<h2> <img src="https://user-images.githubusercontent.com/121436228/211121739-d18453e4-9d55-4845-85ec-8a968e614174.png"/>Second Rudiment: Installing Internet Information Service <img src="https://user-images.githubusercontent.com/121436228/211121751-8b7e050b-4db2-495e-9041-d5aea28c2c36.png"/></h2>
...
2. Go to "File Explorer" and then to "Downloads"
...
9. Then, on the right side of the IIS manager, click "Browse *.80 (HTTP)"
...
14. Hit the "Enable or disable an extension"
...
18. Go to the "File Explorer" then "C:/inetpub/wwwroot/osticket/include"
19. Look for the file "osT-sampleconfig" and then rename it by erasing the word "sample"
...
25. Go back to the osTicket Installer, then click "Continue"
...
27. __The osTicket Installer's process is not finished because the HeidiSQL is the database's "middle man"__
...
HeidiSQL is for directory operation purposes and we are going to connect it to Port 3306, which is the MySQL's protocol.
...
2. Under the Database Setting, fill out the Database name as "osTicket"
3. MySQL's username is "root"
4. Put the password
...
<h2><img src="https://user-images.githubusercontent.com/121436228/211122366-73a28fe2-5073-48f8-a34a-1d91b1348233.png"/>osTicket's Post-Installation<img src="https://user-images.githubusercontent.com/121436228/211122366-73a28fe2-5073-48f8-a34a-1d91b1348233.png"/></h2>
 ...
 2. This is how the User fills out a new ticket or checks their ticket's status
<p><img src="https://user-images.githubusercontent.com/121436228/211053375-ec170f6d-6738-4262-8504-567e06d7d385.jpg"/>
  </p>
 
3. Here is where the Admin login and the following photo is the inside of osTicket's operation
